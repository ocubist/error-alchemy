...
module.exports = (0, translatable_1.buildIncompleteTranslation)({
    ...
    docs_could_not_be_generated: "上記のエラーのためドキュメントを生成できませんでした",
    ...
    custom_theme_does_not_define_getSlugger: "カスタムテーマはgetSlugger(reflection)メソッドを定義していませんが、マークダウンをレンダリングしようとします",
    ...
    help_hideParameterTypesInTitle: "署名タイトルのパラメータタイプを非表示にしてスキャンしやすくします",
